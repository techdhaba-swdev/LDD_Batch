...
#define DEVICE_NAME "my_ioctls_device" // Name of the device
...
MODULE_DESCRIPTION("A simple Linux char driver with ioctl for calculator operations"); // Define the description of the modules
