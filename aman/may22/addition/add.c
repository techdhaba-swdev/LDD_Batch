...
#define DEVICE_NAME "my_addition_device"
...
static ssize_t my_device_write(struct file *file, const char __user *buffer, size_t len, loff_t *ppos) {
    int num1, num2, num3, num4, num5, num6, num7, num8, num9, num10, result;
    char operation;
    ...
    printk(KERN_INFO "Received operation: %c, num1: %d, num2: %d, num3 %d, num4 %d, num5 %d, num6 %d, num7 %d, num8 %d, num9 %d, num10 %d\n", operation, num1, num2, num3, num4, num5, num6, num7, num8, num9, num10);

    if (operation == '+') {
        result = (num1 + num2),(num1+ num3),(num1 + num4),(num1 + num5),(num1 + num6),(num1 + num7),(num1 + num8),(num1 + num9),(num1 + num10),(num2 + num10);
    } //else if (operation == '-') {
        //result = num1 - num2;
   // }
    else {
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("aman");
MODULE_DESCRIPTION("addition in Device Driver with mmap");
