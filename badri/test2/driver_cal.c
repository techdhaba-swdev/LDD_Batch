...
#define DEVICE_NAME "my_device_calc"
#define DEVICE_MEMORY_SIZE 4096  // 4KB

static char *device_memory;
static int major_number;
static int result = 0; // Store the result of the calculation
...
static ssize_t my_device_read(struct file *file, char __user *buffer, size_t count, loff_t *ppos) {
    ...
    int length = snprintf(result_buffer, sizeof(result_buffer), "%d", result);
