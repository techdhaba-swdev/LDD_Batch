...
static unsigned char bulk_buf[512]="HI WORLD";
...
//probe is nothing but checking if usb connected is matching the criteria specified in usb_table in usb_driver structure
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("Sarath Chandra M");
