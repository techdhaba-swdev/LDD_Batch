...
#define DEVICE_PATH "/dev/basic_char_device"
#define BUFFER_SIZE 1024

int main() {
    int fd;
    char write_buffer[BUFFER_SIZE] = "Hello, I am Kiruthiga Vengadapathy!";
    ...
    printf("Write %zd to the device: %s\n", bytes_written, write_buffer);
    ...
    printf("Read %zd from the device: %s\n", bytes_read, read_buffer);
