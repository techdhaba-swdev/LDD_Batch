...
#define REVERSE_STRING_IOCTL _IO('R', 0)


#define DEVICE_NAME "reverses_strings"
...
static long reverse_dev_ioctl(struct file *file, unsigned int cmd, unsigned long arg) {
    switch (cmd) {
        case REVERSE_STRING_IOCTL:
            // Reverse the string
