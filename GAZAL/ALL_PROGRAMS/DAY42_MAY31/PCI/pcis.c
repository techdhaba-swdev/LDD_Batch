...
#define PCI_VENDOR_ID_SAMPLE 0x1234  // Replace with your PCI device's vendor ID
#define PCI_DEVICE_ID_SAMPLE 0x5678  // Replace with your PCI device's device ID

#define DRIVER_NAME "pcis"
