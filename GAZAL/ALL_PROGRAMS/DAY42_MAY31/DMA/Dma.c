...
static int simple_dma_probe(struct pci_dev *pdev, const struct pci_device_id *ent) {
    ...
    dev_info(&pdev->dev, "simple_dma_probe called\n");
    ...
    dev_info(&pdev->dev, "PCI device enabled\n");
    ...
    dev_info(&pdev->dev, "Scatter-gather list mapped\n");
    ...
    dev_info(&pdev->dev, "DMA setup complete\n");
