...
static ssize_t calculator_dev_write(struct file *file, const char *buf, size_t count, loff_t *offset) {
...
static ssize_t calculator_dev_read(struct file *file, char *buf, size_t count, loff_t *offset) {
    int len = 0;
    if (result >= 0) {
