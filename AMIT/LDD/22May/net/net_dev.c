...
#define DRIVER_NAME "simple_net"

static struct net_device *net_dev;

static int simple_my_open(struct net_device *dev) {
...
static int __init simple_init(void) {
   // int result;
    ...
    net_dev = alloc_netdev(0,"net%d",NET_NAME_UNKNOWN,setup);
