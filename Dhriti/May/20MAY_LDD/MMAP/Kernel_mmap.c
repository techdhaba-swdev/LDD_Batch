...
#define DEVICE_NAME "mmap_prog"        // Name of the device
...
MODULE_DESCRIPTION("Example Device Driver with mmap");  // Specify the description of the module
