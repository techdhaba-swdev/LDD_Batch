...
#include <linux/uaccess.h>             // Required for user space access
#include <linux/cdev.h>                // Required for character devices
#include <linux/device.h>              // Required for device creation
